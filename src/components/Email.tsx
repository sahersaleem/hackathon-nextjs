    ...
    <div className='bg-off-white lg:py-20'>
        <Wrapper>
            <div className=' bg-white py-20 '>
                ...
                <div className='flex justify-center mt-20 xs:flex-col lg:flex-row'><input placeholder='your@email.com' className='w-[327px] px-7 hover:outline-none bg-off-white py-5'/><button className='btn'>Sign Up</button></div>
