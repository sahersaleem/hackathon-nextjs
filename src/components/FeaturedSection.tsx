...
const FeaturedSection = ({className}:{className:string}) => {
  ...
  <Wrapper><div className=" py-20 flex flex-col justify-around gap-y-20 ">
    <h3 className="xs:text-left lg:text-center xs:mx-6 sm:mx-0">What makes our brand different</h3>
    <div className=" flex xs:justify-center xs:gap-y-12 lg:gap-y-0 lg:justify-between xs:flex-wrap lg:flex-nowrap">
